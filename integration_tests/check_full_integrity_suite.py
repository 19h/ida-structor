...
def main() -> int:
    ...
    suites = [
        ...
        ("flow precision and budget regressions", [sys.executable, "integration_tests/check_flow_precision.py", *common]),
        ...
        ("global flow-budget precision", [sys.executable, "integration_tests/check_global_flow_precision.py", *common]),
